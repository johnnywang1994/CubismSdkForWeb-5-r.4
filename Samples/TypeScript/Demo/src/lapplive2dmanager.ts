...
export class LAppLive2DManager {
  ...
  private changeScene(index: number): void {
    ...
    if (LAppDefine.ModelFileName) {
      // resourcesPath が既に含むディレクトリ名を使用
      modelPath = LAppDefine.ResourcesPath;
      modelJsonName = LAppDefine.ModelFileName;
      if (LAppDefine.DebugLogEnable) {
      ...
      modelJsonName = LAppDefine.ModelDir[index] + LAppDefine.ModelJsonExtension;
      if (LAppDefine.DebugLogEnable) {
