...
export class LAppSubdelegate {
  ...
  public initialize(canvas: HTMLCanvasElement): boolean {
    ...
    if (LAppDefine.CanvasSize === 'auto' || LAppDefine.CanvasSize === 'screen') {
      this.resizeCanvas();
    } else if (typeof LAppDefine.CanvasSize === 'object') {
      canvas.width = LAppDefine.CanvasSize.width * LAppDefine.Quality;
      canvas.height = LAppDefine.CanvasSize.height * LAppDefine.Quality;
    }
