...
export class LAppTextureManager {
  ...
  public createTextureFromPngFile(
    ...
    console.log('[LAppTextureManager] createTextureFromPngFile called with fileName:', fileName);
    ...
    img.addEventListener(
      'load',
      (): void => {
        console.log('[LAppTextureManager] Image loaded successfully:', fileName);
        // テクスチャオブジェクトの作成
    ...
    console.log('[LAppTextureManager] Setting img.src to:', fileName);
    img.src = fileName;
  }
